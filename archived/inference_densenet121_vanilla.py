...
Vanilla model on the NIH Chest X-ray test dataset.
"""
...
def main():
    ...
    model.load_state_dict(torch.load(cfg.artifacts / "densenet121_vanilla_best.pth"))
    ...
    model.load_state_dict(torch.load(cfg.artifacts / "densenet121_vanilla_final.pth"))
    ...
    with open("results/inference_results_vanilla.txt", "w") as f:
