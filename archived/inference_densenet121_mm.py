...
MultiModal models on the NIH Chest X-ray test dataset.
"""
...
def main():
    ...
    model.load_state_dict(torch.load(cfg.artifacts / "densenet121_mm_best.pth"))
    ...
    model.load_state_dict(torch.load(cfg.artifacts / "densenet121_mm_final.pth"))
    ...
    with open("results/inference_results_mm.txt", "w") as f:
