...
def plot_training_curves(train_losses, val_losses, train_aucs, val_aucs):
    ...
    plt.xlabel("Epoch")
    plt.ylabel("Loss")
    plt.title("Training and Validation Loss Embedded")
    plt.legend()
    ...
    plt.xlabel("Epoch")
    plt.ylabel("AUC-ROC")
    plt.title("Training and Validation AUC-ROC Embedded")
    plt.legend()
...
def main():
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if val_loss < best_val_loss:
            ...
            file_path = cfg.artifacts / "densenet121_embedded_best.pth"
    ...
    # Save final model
    final_model_path = cfg.artifacts / "densenet121_embedded_final.pth"
