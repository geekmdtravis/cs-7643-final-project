...
def main(model_path):
    ...
    ablated_feature_values = {0: 0.5, 1: 0.5, 2: 0.5, 3: 0}
    ...
    auroc_df_diff = auroc_df_transposed.subtract(
        auroc_df_transposed.loc["None"], axis=1
    )

    plt.figure(figsize=(15, 8))
    sns.heatmap(
        auroc_df_diff, annot=auroc_df_transposed, cmap="Spectral", fmt=".3f", cbar=False
    )
