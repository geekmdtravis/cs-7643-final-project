"""
Run inference using trained ViT_Base_32
...
def main():
    ...
    model.load_state_dict(torch.load(cfg.artifacts / "ViT_base_32_vanilla_final.pth"))
    ...
    with open("results/ViT_Base_32_inference_results_vanilla_2024-04-20_6_25_am.txt", "w") as f:
