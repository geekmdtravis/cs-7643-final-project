"""
Run inference using trained generic CXR model targeting a specific
model via the hyperparameters.
"""
...
def main():
    ...
    model.load_state_dict(torch.load(cfg.artifacts / "cxr_model_best.pth"))
    ...
    with open("results/inference_results_cxr.txt", "w") as f:
